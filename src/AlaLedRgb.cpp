...
void AlaLedRgb::initWS2811(OctoWS2811 *pLeds)
{
...
void AlaLedRgb::setBrightness(AlaMax maxOut)
{
    this->maxOut = maxOut;
}
...
bool AlaLedRgb::runAnimation()
{
    ...
    for(int i = 0; i < numLeds; i++)
    {
        pOctoWS2811Leds->setPixel(i, leds[i].WS2811Color(maxOut));
    }
    pOctoWS2811Leds->show();
